...
namespace Avalonia.Controls.Presenters
{
    ...
    /// </summary>
    internal class ItemVirtualizerGroup : ItemVirtualizer
    {
...
//                System.Console.WriteLine($"GroupDummy {_id} {materialized.ContainerControl.DesiredSize} {_scrollViewer.Bounds.Height}");
        ...
        {
//            System.Console.WriteLine($"Group Scroll {_id} {e.ExtentDelta} {e.OffsetDelta} {e.ViewportDelta}");
            _itemsPresenter.InvalidateMeasure();
        }
